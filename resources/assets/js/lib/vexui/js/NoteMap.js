...
Vex.UI.NoteMap.prototype.getNoteName = function(stave, mousePos) {
	...
	// Step 2: Get in which space within the staves the user clicked using half the space between lines because we can click between a line (each line can hold 2 notes).
