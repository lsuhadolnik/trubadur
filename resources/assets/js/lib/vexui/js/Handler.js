/*
 * Handler class is responsible for starting all the events needed for the VexFlow User Interface to work.
 */
...
Vex.UI.Handler.prototype.redrawStave = function(stave){
	...
	// TODO: The +12 and +5 values are to erase part of a note that could be out of the bounding box. This values shouldn't be absolute.
...
Vex.UI.Handler.prototype.drawNotes = function(stave) {
	if (stave === undefined) {
		...
		// Draw notes on Stave passed as function argument
	...
	if (this.provisoryTickable && this.currentStave!=null){
		...
		if (mousePos !== undefined) {
			if (this.provisoryTickable instanceof Vex.Flow.StaveNote) {
				// TODO: Fix x position to set exactly where the mouse is. The -5 value should not be absolute, but the be half the note's width.
